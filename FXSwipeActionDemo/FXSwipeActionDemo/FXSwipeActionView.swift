...
struct FXSwipeActionView: ViewModifier {
    ...
    func body(content: Content) -> some View {
        GeometryReader { geo in
            ...
            .onChange(of: dragGestureActive) {
                let newValue = dragGestureActive
            ...
            .onChange(of: fxswipeViewGroupSelection.wrappedValue) {
                let newValue = fxswipeViewGroupSelection.wrappedValue
